...
export const RequestModel = new rpc.RequestType1<string, any | undefined, void>('server/request');
export const UpdateModel = new rpc.RequestType2<string, any, void, void>('server/update');
export const SaveModel = new rpc.RequestType2<string, any, void, void>('server/save');
export const ReferenceModel = new rpc.RequestType2<string, any, void, void>('server/references');
...
export class ModelServer implements Disposable {
   ...
   protected async requestModel(uri: string): Promise<any | undefined> {
      const root = await this.modelService.request(uri, isAstNode);
      return toSerializable(root) as any;
   }
